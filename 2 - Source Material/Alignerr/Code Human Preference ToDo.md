...
Currently tabs corrupt terminal layout and hide information, null bytes truncate output silently, invisible Unicode characters prevent debugging, and ANSI escape codes execute unintentionally, making it impossible to debug special characters or parse logs. Make IceCream outputs strings in a way that preserves all information by default. 
